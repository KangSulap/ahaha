...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
        ...
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `${NamaBot}`, "footerText": "*_© DₚᵢₙBₒₜz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if(budy.includes('Dpin')){
cpref = `Hayo Ngomongin Dpin Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('dpin')){
cpref = `Hayo Ngomongin dpin Ganteng Yaaa Aowkowkwoo`
...
if(isButton == 'igm'){
reply('http://instagram.com/_dvnrngg.id')
}
if(isButton == 'ytm'){
reply('http://xnxx.com')
}
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© DₚᵢₙBₒₜz_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'𝙨𝙩𝙤𝙧𝙚 𝙢𝙚𝙣𝙪'},type:1},{buttonId:`sc`,buttonText:{displayText:'SC'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
`
sendButLocation(from, `${menu}`, "*_© ⒟⒫⒤⒩ ⒭⒜⒩⒢⒢⒜_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
case 'catalog': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                ...
                nama = ' CATALOG MENU '
       ownerJid = "6283847204232@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
...
sendButLocation(from, `${menu}`, "*_© DₚᵢₙBₒₜz_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
ɢɪᴛʜᴜʙ ᴏᴡɴᴇʀ:https://github.com/KangSulap
ʸᵒᵘᵗᵘᵇᵉ ᵒʷⁿᵉʳ:https://xnxx.com`
sendButLocation(from, `${menu}`, "*_© DₚᵢₙBₒₜz_*", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `DₚᵢₙBₒₜzL`,
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script ${NamaBot}`,
          "url": "https://github.com/KangSulap"
        },
        "index": 0
      }
    ]
...
case 'chiisaihentai':
              ...
              buttonsMessage = {footerText:'✗✗✗ ďקȋñ', imageMessage: imageMsg,
              contentText:`halahjemboed`,buttons,headerType:4}
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=KurrXd&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `⒟⒫⒤⒩ ⒭⒜⒩⒢⒢⒜`, quoted : ftrol})
                    })
                    break
case 'neko':
       case 'kanna':
